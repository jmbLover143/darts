...
<body class=" ">
    ...
    <br/>
                <form action="print-single-score.php" target="_blank" method="POST">
   ...
   Darts Tournament Score Sheets
        ...
        <table style="border:1px solid black;height:500px;" class="sheets">
            <tr>
                <thead style="border:1px solid whitesmoke"><b>SINGLE PLAYER</b></thead>
                ...
                <tr class="sheets">
                    <td class="sheets">
                        ...
                        <select name="n1"> 
                            ...
                            $q = "Select name From single_discipline Where date='$_SESSION[date]'";
