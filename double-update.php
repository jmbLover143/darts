...
if(empty($name)){
     ...
     $query = "UPDATE team SET player1='$name',player2='$name2',date='$date' WHERE id='$id' AND date = '$date'";
         ...
         <form  action="" method="POST">                            
             <input type="hidden" name="date" value="<?php echo date('m / d / Y')?>"/>
              <table>
                 ...
                 <tr>
                     <td><p>Player ID:</p></td> 
                     <td><input name="id" type="" readonly="readonly" value="<?php echo $_REQUEST['id']?> "/></td>
