...
<body class=" ">
    ...
    <div class="side">
        ...
        <div class="container">
            <a href="all-team-player-discipline.php"><button>BACK</button></a>
        </br>
 </br>
 <form action="download-double-discipline.php" method="POST">
         ...
         <div class="records">     
             <table style="overflow: scroll">
                  ...
                  <thead><b>DATE REGISTERED: </b></thead>
                         <tr style=" text-align: center;background-color: whitesmoke;border:1px solid lightgray;width:500px">
                                                          <td style="width:830px;background-color: whitesmoke;text-align: center "><b>PLAYER 1</b></td>
                            <td style="width:830px;background-color: whitesmoke;text-align: center "><b>PLAYER 2</b></td>
                         </tr>  
                ...
                if($result -> num_rows > 0){
                    while($row = $result -> fetch_assoc()){
                        ...
                        echo"<tr style='border:1px solid lightgray'>                    
                         <td style='width:700px;background-color: white;text-align: center '><p style='text-transform:uppercase'>" . $row['player1'] . "</p></td>
                        <td style='width:700px;background-color: white;text-align: center '><p style='text-transform:uppercase'>" . $row['player2'] . "</p></td>
             ...
             <button class="btn btn-primary">DOWNLOAD RECORDS</button>      
               ...
               <h4 style="margin-top:-550px;margin-left: 180px">Total Records : <?php echo $count?></h4>
