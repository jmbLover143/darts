...
<body class=" ">
    ...
    <div class="side">
     ...
     <img style="height:50px;margin-top: -10px" src="lib/image/delete.png">
         ...
         <a href="all-single-records.php"><button style="width:186px;float: right;margin-top: -47px" class="btn btn-primary">CANCEL</button></a>
         </center>
    ...
    <form action="delete-records-single-action.php" method="POST">
