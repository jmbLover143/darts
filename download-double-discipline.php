...
include ('connection.php');
  ...
  header("Content-type: application/msword");
        header("Content-Disposition: attachment; filename= TeamPlayerDisciplineRecords" . $c . ".doc");
...
<body class=" ">
 ...
 <form action="" method="POST">
         ...
         <center>
             ...
             <h4>Team Player Discipline List</h4>
         </center>
         ...
         <div class="records">     
             <table style="overflow: scroll;">
                ...
                $query = "Select id,player1,player2 From double_discipline Where date='$d'";
