...
<body class=" ">
     ...
     <img style="height:50px;margin-top: -10px" src="lib/image/delete.png">
         <h4>Are you sure you want to delete all records ?</h4>
          <br/>
              ...
              <a href="all-single-discipline.php"><button style="width:186px;float: right;margin-top: -47px" class="btn btn-primary">CANCEL</button></a>
         </center>
    ...
    <form action="delete-single-disc-action.php" method="POST">
