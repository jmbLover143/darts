...
if(empty($name)){
     ...
     $query = "UPDATE double_discipline SET player1='$name',player2='$name2',date='$date' WHERE id='$id' AND date = '$date'";
     $result = mysqli_query($conn,$query);
  
     if(!$result){
         echo "WRONG.!!";
     }else{
         header("Location:discipline-double.php");
     }    
}
}
?>
...
<body class=" ">
    ...
    <div class="side">
     ...
     <img style="height:50px;margin-top: -10px" src="lib/image/update.png">
         <h4>Updating for team Player</h4>
         <br/>
         ...
         <form  action="" method="POST">                            
             <input type="hidden" name="date" value="<?php echo date('m / d / Y')?>"/>
              <table>
                 <tr>
                     <td><p>Player 1:</p></td> 
                     <td><input value="<?php echo $_REQUEST['player1']?>" name="name" id="name" placeholder="name"  /></td>
                     
                </tr>
                  <tr>
                     <td><p>Player 2:</p></td> 
                     <td><input value="<?php echo $_REQUEST['player2']?>" name="name2" id="name" placeholder="name"  /></td>
                     
                </tr>
                 <tr>
                     <td><p> </p></td> 
                     <td><input name="id" type="hidden" readonly="readonly" value="<?php echo $_REQUEST['id']?> "/></td>
                     
             </tr>
                  <tr>
                      <td></td>
                      <td><button style="" type="submit" name="submit" class="btn btn-success">UPDATE PLAYER</button></td>
                  </tr>
         </table>
