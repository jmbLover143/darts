         ...
         <div style="height:400px;width: 780px;border: 1px solid whitesmoke;overflow: scroll">
             ...
             <table style="overflow:scroll">
                  <tr>
                      ...
                      <td><button style="width:300px;margin-left: 200px" type="" name="" class="btn btn-success" >TEAM PLAYER</button></a></td>                  
                  </tr>               
                  ...
                  <?php
                include ("connection.php");                
                $query = "Select Distinct date From team";
                $result = mysqli_query($conn, $query);         
                $count =0;
                    ...
                    while($row = $result -> fetch_assoc()){
                        ...
                        echo"<tr style='border:1px solid lightgray'>                    
                         <td style='width:100px;background-color: white;text-align: center '><p style='text-transform:uppercase'>" . $row['date'] . "</p></td>
                          <td><a href='all-team-view-display.php?date=$row[date]'><button style='width:100px' name='id' type='button' data-toggle='modal' data-target='#exampleModalCenter' class='btn btn-primary'>VIEW</button></td></a>
                          <td><a href='all-team-view-display-delete.php?date=$row[date]'><button style='width:110px'  name='id' type='button' data-toggle='modal' data-target='#exampleModalCenter' class='btn btn-danger'>DELETE</button></td></a>
