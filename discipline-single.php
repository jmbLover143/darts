...
if(empty($name) ){
    ...
    header("Location:discipline-single.php");   
}else{
      $query = "INSERT into single_discipline(name,date) VALUES ('$name','$d')";
...
<body class=" ">
    ...
    <div class="side">
        ...
        <div class="container">
         ...
         <h4>Registration for single Player Discipline</h4>
         <br/>
         ...
         <div style="border:1px solid whitesmoke;height:430px;width:940px;overflow: scroll">
             
         
         <div class="records">     
             <table style="overflow: scroll">
                  <thead><b>SINGLE PLAYER DISCIPLINE</b></thead>
                         <tr style=" text-align: center;background-color: whitesmoke;border:1px solid lightgray;width:500px">
                             ...
                             <td style="width:700px;background-color: whitesmoke;text-align: center "><b>FULL NAME</b></td>
                              <td style="width:67px;background-color: whitesmoke;text-align: center;height:35px">ACTION</td>                   
                                   ...
                                   <?php
                include ("connection.php");                
                $query = "Select id,name From single_discipline Where date='$d'";
                $result = mysqli_query($conn, $query);         
                $count =0;
                if($result -> num_rows > 0){
                    while($row = $result -> fetch_assoc()){
                        ...
                        echo"<tr style='border:1px solid lightgray'> 
                           <td style='width:700px;background-color: white;text-align: center '><p style='text-transform:uppercase'>" . $row['name'] . "</p></td>
                          <td><a href='update-discipline-single.php?name=$row[name]&id=$row[id]'><button name='id' type='button' data-toggle='modal' data-target='#exampleModalCenter' class='btn btn-success'>UPDATE</button></td></a>
                            </tr>";
    }                
}
             ...
             <a href="drawboards-single.php" target="_blank"><button class="btn btn-deep-orange" >PROCEED TO DRAW BOARDS</button></a>
             <a href="score-sheets-single.php" target="_blank"><button type="button" class="btn btn-warning" data-toggle="modal" data-target="#exampleModalCenter">PROCEED TO SCORE SHEET</button></a>
              <h3 style="margin-top:-510px;margin-right: -780px">Total Players : <?php echo $count?></h3>
