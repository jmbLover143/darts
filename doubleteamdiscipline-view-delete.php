...
<body class=" ">
    ...
    <div class="side">
        ...
        <div  class="update">
         ...
         <br/>
            ...
            <center style="border: 1px solid whitesmoke;width:600px;height:400px;margin:0 auto;border-radius: 5px;">
                        
              <br/>
                </br>
     </br>
     <img style="height:50px;margin-top: -10px" src="lib/image/delete.png">
         <h4>Are you sure you want to delete all records ?</h4>
          <br/>
              ...
              <table>
                 <tr>
                     <td><p>DATE:</p></td> 
                     <td><input value="<?php echo $_REQUEST['date']?>" name="date" id="date" placeholder="" readonly="readonly"/></td>
                  ...
                  <tr>
                      <td></td>
                      <td>
                          <button type="button" name="" class="btn btn-warning" data-toggle="modal" data-target="#exampleModalCenter">DELETE ALL RECORDS</button>
                      </td>
                  </tr>
         </table>
            
              <a href="all-team-player-discipline.php"><button style="width:186px;float: right;margin-top: -47px" class="btn btn-primary">CANCEL</button></a>
         </center>
    ...
    <form action="delete-records-double-disciplne-action.php" method="POST">
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
       <div class="modal-header">
        ...
        <h5 class="modal-title" id="exampleModalLongTitle">SUMMER TOURNAMENT 2020</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
          <h5 class="modal-title" id="exampleModalLongTitle" style="color:red">Are you sure you want to delete all records for this date  ?</h5>
        <input value="<?php echo $_REQUEST['date']?>" name="date" id="date" placeholder="" readonly="readonly"/>
      </div>
      <div class="modal-footer">
          <a href=""><input  type="submit"class="btn btn-danger"   value="DELETE" style="margin-top: 50px; padding: 15px 35px;width:200px;height:50px; font-size: 130%;"></a>

            <a href=""><input class="btn btn-primary" data-dismiss="modal"   value="Cancel" style="margin-top: 50px; padding: 15px 35px; font-size: 130%;width:200px;height:50px;"></a>
