...
include ('connection.php');
  ...
  header("Content-type: application/msword");
        header("Content-Disposition: attachment; filename= TeamPlayerRecords" . $c . ".doc");
             ...
             <table style="overflow: scroll;">
                 <form>
                          <tr style=" border:1px solid whitesmoke;text-align: center;background-color: whitesmoke;border:1px solid lightgray;width:500px">
                             <td style="width:90px;border:1px solid whitesmoke;text-align: center;background-color: whitesmoke;">ID</td>
                            <td style="width:830px;border:1px solid whitesmoke;background-color: whitesmoke;text-align: center "><b>PLAYER 1</b></td>
                         <td style="width:830px;border:1px solid whitesmoke;background-color: whitesmoke;text-align: center "><b>PLAYER 2</b></td>
                          </tr>  
                ...
                $query = "Select id,player1,player2 From team Where date='$d'";
                ...
                if($result -> num_rows > 0){
                    while($row = $result -> fetch_assoc()){
                        ...
                        <td style='width:90px;text-align: center;background-color: white;height:20px;border:1px solid whitesmoke'>" . $row['id'] . "</td>
                                              <td style='width:700px;background-color: white;text-align: center;;border:1px solid whitesmoke;height:20px; '><p style='text-transform:uppercase'>" . $row['player1'] . "</p></td>    
                        <td style='width:700px;background-color: white;text-align: center;;border:1px solid whitesmoke;height:20px; '><p style='text-transform:uppercase'>" . $row['player2'] . "</p></td>
                             </tr>";
    }                
}             
                ?>  
