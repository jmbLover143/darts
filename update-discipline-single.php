...
if(empty($name)){
     ...
     $query = "UPDATE single_discipline SET name='$name',date='$date' WHERE id='$id' AND date='$date'";
...
<body class=" ">
    ...
    <div class="side">
     ...
     <img style="height:50px;margin-top: -10px" src="lib/image/update.png">
         <h4>Updating for single Player</h4>
         <br/>
         ...
         <form  action="" method="POST">                            
             <input type="hidden" name="date" value="<?php echo date('m / d / Y')?>"/>
              <table>
                 <tr>
                     <td><p>Update fullname:</p></td> 
                     <td><input value="<?php echo $_REQUEST['name']?>" name="name" id="name" placeholder="name"  /></td>
