...
<body class=" ">
    ...
    <div class="side">
        ...
        <div class="container">
            <a href="all-single-discipline.php"><button>BACK</button></a>
        </br>
 </br>
 <form action="download-single-disc.php" method="POST">
             ...
             <table style="overflow: scroll">
                  ...
                  <thead><b>DATE REGISTERED: </b></thead>
                         <tr style=" text-align: center;background-color: whitesmoke;border:1px solid lightgray;width:500px">
                             <td style="width:830px;background-color: whitesmoke;text-align: center "><b>FULL NAME</b></td>
                         </tr>  
