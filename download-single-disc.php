...
include ('connection.php');
  ...
  header("Content-type: application/msword");
        header("Content-Disposition: attachment; filename= SinglePlayerDiscipline" . $c . ".doc");
             ...
             <table style="overflow: scroll;">
                ...
                if($result -> num_rows > 0){
                    while($row = $result -> fetch_assoc()){
                        ...
                        <td style='width:700px;background-color: white;text-align: center;;border:1px solid whitesmoke;height:20px; '><p style='text-transform:uppercase'>" . $row['name'] . "</p></td>
                             </tr>";
    }                
}             
                ?>  
