...
<body class=" ">
    ...
    <center>
     <br/>                    
    <div style="width:300px"class="alert alert-primary" role="alert">Darts Tournament Board Single</div>
    ...
    <div class="draw">
        ...
        <form  action="save-score-single.php" method="POST">
            ...
            <tr>
                <td>
                    <select name="play1" style="border:1px solid black;background-color: white">
                        ...
                        $qu = "Select name from single_discipline Where date = '$da'";
                        $re  = mysqli_query($conn, $qu);
                        
                         if($re -> num_rows > 0){
                    while($row = $re -> fetch_assoc()){           
                        echo"                   
                        <option name='n1'>" . $row['name'] . "</option>";
                    }
                         }
                        ?>
                    </select>
