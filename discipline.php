...
<body class=" ">
    ...
    <div class="side">
        ...
        <div  class="update">
         ...
         <h4>Register Player for each Discipline </h4>
         <br/>                              
             <input type="hidden" name="date" value="<?php echo date('m / d / Y')?>"/>
              <table>
                  <tr>
                      <td></td>
                      <td><a href="discipline-single.php"><button style="width:400px" type="submit" name="submit" class="btn btn-success" >SINGLE PLAYER</button></a></td>
                  </tr>               
                  <tr>
                      <td></td>
                      <td><a href="discipline-double.php"><button style="width:400px" type="" name="" class="btn btn-success">TEAM PLAYER</button></a></td>
                  </tr>
         </table>
