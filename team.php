...
if(empty($name) || empty($name2) ){
    ...
    $count = $c + 1;
     ...
     $query = "INSERT into team(id,player1,player2,date) VALUES ('$count','$name','$name2','$date')";
...
<body class=" ">
    ...
    <div class="side">
        ...
        <div class="container">
         ...
         <h4>Registration for team Player</h4>
         <br/>
         ...
         <div style="border:1px solid whitesmoke;height:470px;width:1050px;overflow: scroll">
             ...
             <table style="overflow: scroll">
                 <thead><b>TEAM PLAYER</b></thead>
                         <tr style=" text-align: center;background-color: whitesmoke;border:1px solid lightgray;width:500px">
                            ...
                            <td style="width:67px;background-color: whitesmoke;text-align: center;height:35px">ACTION</td>
                                   ...
                                   <?php
                include ("connection.php");                
                $query = "Select id,player1,player2 From team Where date='$d' order by id DESC";
                $result = mysqli_query($conn, $query);         
                $count =0;
                if($result -> num_rows > 0){
                    while($row = $result -> fetch_assoc()){
                        ...
                        <td><a href='double-update.php?id=$row[id]&player1=$row[player1]&player2=$row[player2]'><button name='id' type='button'  class='btn btn-success'>UPDATE</button></td></a>
                            </tr>";
    }                
}             
                ?>  
